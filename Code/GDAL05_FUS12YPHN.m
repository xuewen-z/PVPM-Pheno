...
for Year = 2001:2017
    ...
    for I_File =1 :numel(FileList) 
        ...
        [FUS12YPHN1,R] = geotiffread([Path_DOY12YPHN,FileName]);
        Proj           = geotiffinfo([Path_DOY12YPHN,FileName]);

        % process current year data to ealiest DOY
        FUS12YPHN1(FUS12YPHN1<  0)=nan;
        FUS12YPHN1(FUS12YPHN1>365)=nan;
        FUS12YPHN1 = min(FUS12YPHN1,[],3);
        ...
        % fusion data
        FUS12YPHN  = min(FUS12YPHN1,FUS12YPHN2);
